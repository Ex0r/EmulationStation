...
const uint32_t res2hNrOfFiles = 45;
...
res2hMapType::value_type mapTemp[] = {
    ...
    std::make_pair(":/off.svg", res2hFiles[1]),
    std::make_pair(":/textinput_ninepatch_active.png", res2hFiles[2]),
    std::make_pair(":/frame.png", res2hFiles[3]),
    std::make_pair(":/star_unfilled.svg", res2hFiles[4]),
    std::make_pair(":/busy_1.svg", res2hFiles[5]),
    std::make_pair(":/window_icon_256.png", res2hFiles[6]),
    std::make_pair(":/opensans_hebrew_condensed_regular.ttf", res2hFiles[7]),
    std::make_pair(":/fav_add.svg", res2hFiles[8]),
    std::make_pair(":/busy_2.svg", res2hFiles[9]),
    ...
    std::make_pair(":/busy_0.svg", res2hFiles[13]),
    std::make_pair(":/textinput_ninepatch.png", res2hFiles[14]),
    std::make_pair(":/checkbox_checked.svg", res2hFiles[15]),
    ...
    std::make_pair(":/button_filled.png", res2hFiles[19]),
    std::make_pair(":/opensans_hebrew_condensed_light.ttf", res2hFiles[20]),
    ...
    std::make_pair(":/busy_3.svg", res2hFiles[24]),
    ...
    std::make_pair(":/help/button_a.svg", res2hFiles[29]),
    std::make_pair(":/help/button_x.svg", res2hFiles[30]),
    std::make_pair(":/help/dpad_all.svg", res2hFiles[31]),
    std::make_pair(":/help/analog_right.svg", res2hFiles[32]),
    std::make_pair(":/help/dpad_leftright.svg", res2hFiles[33]),
    std::make_pair(":/help/analog_thumb.svg", res2hFiles[34]),
    std::make_pair(":/help/button_r.svg", res2hFiles[35]),
    std::make_pair(":/help/dpad_up.svg", res2hFiles[36]),
    std::make_pair(":/help/button_b.svg", res2hFiles[37]),
    std::make_pair(":/help/analog_down.svg", res2hFiles[38]),
    std::make_pair(":/help/dpad_updown.svg", res2hFiles[39]),
    std::make_pair(":/help/dpad_down.svg", res2hFiles[40]),
    std::make_pair(":/help/button_l.svg", res2hFiles[41]),
    std::make_pair(":/help/analog_left.svg", res2hFiles[42]),
    std::make_pair(":/help/button_select.svg", res2hFiles[43]),
